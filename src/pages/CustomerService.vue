  ...
  <div class="l-container" style="position: relative">
    ...
    <div class="l-card" style="position: relative;background: #00abf5;" ref="pagePanel">
      <div class="chat-gpt-box" v-for="(item,index) in messageList" :key="index"
           :style="item.isGPT?'':'margin-left:auto'">
        <div class="avatar-box" v-if="item.isGPT">
          <svg width="41" height="41" viewBox="0 0 41 41"
               fill="none" xmlns="http://www.w3.org/2000/svg" class="h-2/3 w-2/3" role="img">
        ...
        <div class="load-pos" v-if="item.isGPT && item.message===''"></div>
        <v-md-preview v-if="item.message!==''" style="border-radius: 18px" :text="item.message"></v-md-preview>
        <div class="avatar-box" v-if="!item.isGPT">
          <svg width="41" height="41" viewBox="0 0 41 41"
               fill="none" xmlns="http://www.w3.org/2000/svg" class="h-2/3 w-2/3" role="img">
            <text x="-9999" y="-9999">ChatGPT</text>
...
@Options({
  ...
  mounted() {
    sessionStorage.setItem("systemToken", "eyJhbGciOiJIUzUxMiJ9.eyJleHAiOjE3MDAxMjcxOTksInN1YiI6IjhCRjUzRDI3QjA2QjRFMjg4NjIwRjZGQUQzRkQ4MDE4IiwiaWF0IjoxNjk5NTIyMzk5Njk1fQ.stj7ead8UF2acxKU53ylkgwVKJN3gmQnFdo743x0FKVSzw7Dvx70fRmtnKZ-JHOf9lACCZxDsaX4MCIDmCuMfg");
    this.initWS();
  },
  methods: {
    getData() {
